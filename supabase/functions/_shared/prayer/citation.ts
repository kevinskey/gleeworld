/**
 * Deno-runtime mirror of src/lib/prayer/citation.ts. See books.ts in this
 * same directory for why this is a duplicate rather than a cross-boundary
 * import, and citation.driftguard.test.ts for the guard against the two
