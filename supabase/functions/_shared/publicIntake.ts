...
// Auditions only. Appointments are handled inline on the public page by
// gw_booking_public_submit; see public-intake/index.ts.
export type IntakeKind = 'audition';
