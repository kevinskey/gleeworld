// Public intake — the write path for anonymous audition submissions.
//
// Appointments are NOT handled here. main's appointment-booking block completes
// a booking inline on the public page via gw_booking_public_submit
// (20260804210000_public_site_booking.sql), which landed while this work was in
// review and solves the same problem without navigating away. Routing bookings
// through here as well would mean two parallel booking systems.
