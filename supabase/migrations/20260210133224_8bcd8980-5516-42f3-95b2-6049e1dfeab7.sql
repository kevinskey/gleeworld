-- Fix process_qr_attendance_scan: remove reference to non-existent session_id column
...
begin
  ...
  -- BRANCH 2: Event-based attendance (NO session_id branch - column doesn't exist)
