-- Phase 1: Core GleeWorld Tables Migration (Safe Version)
...
CREATE TABLE IF NOT EXISTS public.gw_fans (
  id uuid primary key default gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS public.gw_hero_settings (
  id uuid primary key default gen_random_uuid(),
  title text not null,
  subtitle text,
...
CREATE TABLE IF NOT EXISTS public.gw_hero_slides (
  id uuid primary key default gen_random_uuid(),
...
-- Music Management
CREATE TABLE IF NOT EXISTS public.gw_music_files (
  id uuid primary key default gen_random_uuid(),
  title text not null,
  artist text,
  album text,
...
CREATE TABLE IF NOT EXISTS public.gw_audio_files (
  id uuid primary key default gen_random_uuid(),
...
-- Video Management  
CREATE TABLE IF NOT EXISTS public.gw_youtube_videos (
  id uuid primary key default gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS public.gw_event_rsvps (
  id uuid primary key default gen_random_uuid(),
...
-- Announcements
CREATE TABLE IF NOT EXISTS public.gw_announcements (
  id uuid primary key default gen_random_uuid(),
  title text not null,
...
-- Site Settings
CREATE TABLE IF NOT EXISTS public.gw_site_settings (
  id uuid primary key default gen_random_uuid(),
...
-- Create policies (using DROP IF EXISTS to avoid duplicates)
...
DROP POLICY IF EXISTS "Public can view public events" ON public.gw_events;
CREATE POLICY "Public can view public events" ON public.gw_events
  FOR SELECT USING (is_public = true);

DROP POLICY IF EXISTS "Public can view announcements" ON public.gw_announcements;
...
DROP POLICY IF EXISTS "Public can view public music" ON public.gw_music_files;
CREATE POLICY "Public can view public music" ON public.gw_music_files
  FOR SELECT USING (is_public = true);

DROP POLICY IF EXISTS "Public can view hero content" ON public.gw_hero_settings;
CREATE POLICY "Public can view hero content" ON public.gw_hero_settings
  FOR SELECT USING (is_active = true);

DROP POLICY IF EXISTS "Public can view hero slides" ON public.gw_hero_slides;
CREATE POLICY "Public can view hero slides" ON public.gw_hero_slides
  FOR SELECT USING (is_active = true);

DROP POLICY IF EXISTS "Public can view youtube videos" ON public.gw_youtube_videos;
...
CREATE INDEX IF NOT EXISTS idx_gw_events_start_date ON public.gw_events(start_date);
CREATE INDEX IF NOT EXISTS idx_gw_events_public ON public.gw_events(is_public) WHERE is_public = true;
CREATE INDEX IF NOT EXISTS idx_gw_music_files_public ON public.gw_music_files(is_public) WHERE is_public = true;
CREATE INDEX IF NOT EXISTS idx_gw_announcements_publish ON public.gw_announcements(publish_date);