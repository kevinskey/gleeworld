...
CREATE TABLE public.gw_practice_links (
...
-- SELECT policies
CREATE POLICY "Users can view their own personal links"
...
CREATE POLICY "Users can view global practice links"
ON public.gw_practice_links
FOR SELECT
USING (
...
CREATE POLICY "Users can view section practice links"
ON public.gw_practice_links
FOR SELECT
USING (
  visibility = 'section'
...
CREATE POLICY "Creators can view their created links"
ON public.gw_practice_links
FOR SELECT
USING (owner_id = auth.uid());

-- INSERT policies
CREATE POLICY "Users can create personal practice links"
ON public.gw_practice_links
FOR INSERT
WITH CHECK (
...
CREATE POLICY "Section leaders/admins can create section links"
ON public.gw_practice_links
FOR INSERT
WITH CHECK (
  visibility = 'section'
...
CREATE POLICY "Leaders/admins can create global links"
ON public.gw_practice_links
FOR INSERT
WITH CHECK (
  visibility = 'global'
...
CREATE POLICY "Owners can update their practice links"
ON public.gw_practice_links
FOR UPDATE
USING (owner_id = auth.uid())
...
CREATE POLICY "Owners can delete their practice links"
ON public.gw_practice_links
FOR DELETE
USING (owner_id = auth.uid());