-- Create tour planner database tables (fixed)
...
CREATE INDEX IF NOT EXISTS idx_tour_documents_tour_id ON gw_tour_documents(tour_id);

-- Create updated_at triggers for tour tables
