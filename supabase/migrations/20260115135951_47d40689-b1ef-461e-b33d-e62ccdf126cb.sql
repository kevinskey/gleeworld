-- Update process_qr_attendance_scan to handle race conditions with exception handling
...
BEGIN
  ...
  -- Record attendance with conflict handling for race conditions
  BEGIN
  ...
  EXCEPTION 
    WHEN unique_violation THEN
      -- Race condition: attendance was just recorded by another request
