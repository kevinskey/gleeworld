...
DO $$
BEGIN
    IF NOT (SELECT ROW_SECURITY_ENABLED FROM information_schema.tables WHERE table_name = 'gw_appointments' AND table_schema = 'public') THEN
