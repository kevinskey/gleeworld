...
DROP FUNCTION IF EXISTS public.sync_gw_event_to_events() CASCADE;
DROP FUNCTION IF EXISTS public.sync_event_to_gw_events() CASCADE;

-- Copy existing profiles to gw_profiles if they don't exist
...
-- Copy all existing events from events table to gw_events table
