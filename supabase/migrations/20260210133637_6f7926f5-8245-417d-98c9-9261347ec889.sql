-- Fix process_qr_attendance_scan: use correct column names for gw_event_attendance
-- Column is 'attendance_status' not 'status', and no 'check_in_method' column exists
...
begin
  ...
  IF v_qr_record.event_id IS NOT NULL THEN
    ...
    -- Record in gw_event_attendance using correct column names (attendance_status, no check_in_method)
