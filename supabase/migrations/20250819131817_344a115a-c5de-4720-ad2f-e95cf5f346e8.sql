-- Grant music library access to all members
-- First, let's get the music library module ID
DO $$
DECLARE
...
BEGIN
    ...
    -- Also update the module to have default view permissions for members
    UPDATE gw_modules 
    SET default_permissions = ARRAY['view']
    WHERE key = 'music-library';
