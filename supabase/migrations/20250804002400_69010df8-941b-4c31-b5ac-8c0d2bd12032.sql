-- Drop existing table and create new one with correct structure
DROP TABLE IF EXISTS public.gw_social_media_posts CASCADE;

-- Create the correctly structured social_posts table
