...
SET description = 'Generate AI-powered sight-reading exercises with professional notation and evaluation',
    ...
    default_permissions = '["view", "manage"]'::jsonb
...
VALUES ('sight-reading-generator', 'Generate AI-powered sight-reading exercises with professional notation and evaluation', 'musical-leadership', true, '["view", "manage"]'::jsonb)
...
-- Add trigger for updated_at if the function doesn't exist
DO $$
BEGIN
