-- Add more role options to mus240_group_memberships
ALTER TABLE public.mus240_group_memberships 
ALTER COLUMN role TYPE text;

-- Update the role column to allow more flexibility
ALTER TABLE public.mus240_group_memberships 
ADD CONSTRAINT valid_member_roles 
CHECK (role IN ('leader', 'co-leader', 'member', 'researcher', 'writer', 'presenter', 'tech-lead'));
