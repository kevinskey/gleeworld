-- Update process_qr_attendance_scan to return course_id for navigation
...
-- Also update process_pin_attendance_scan to return course_id
CREATE OR REPLACE FUNCTION process_pin_attendance_scan(
  pin_code_param TEXT,
  user_id_param UUID,
  scan_location_param JSONB DEFAULT NULL
)
