...
(VALUES
  ...
  ('Destiny Mitchell', 'destiny.mitchell@students.spelman.edu', '(404) 555-1009', CURRENT_DATE + INTERVAL '1 week 1 day 14 hours 45 minutes', 'submitted', 'Freshman', 'Soprano', 'Beginner', 'Church choir', 1, ARRAY[], '"Amazing Grace"', 'To glorify God through music and grow in my faith journey.', 'Strengthen my voice for worship and performance', 'None', 'Sunday morning church commitments', 'Strong spiritual connection to music', NULL, NOW() - INTERVAL '8 hours'),
