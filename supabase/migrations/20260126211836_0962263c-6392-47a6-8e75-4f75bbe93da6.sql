-- Make event_id nullable in gw_attendance_qr_codes since sessions may not have events
ALTER TABLE gw_attendance_qr_codes ALTER COLUMN event_id DROP NOT NULL;

-- Update the function to handle null event_id gracefully
...
BEGIN
  ...
  -- Create new QR code record (event_id can be null for session-based attendance)
  INSERT INTO gw_attendance_qr_codes (
    ...
    v_session.event_id,  -- may be null
    p_session_id,
    v_session.course_id,
    v_qr_token,
    p_generated_by,
