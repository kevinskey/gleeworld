-- Fix the get_user_modules function to handle null user_id cases and ensure it works
...
BEGIN
  ...
  individual_modules AS (
    ...
    AND NOT (up.is_admin = true OR up.is_super_admin = true) -- Skip if admin
  ...
  SELECT a.module_key, a.module_name, a.can_view, a.can_manage, a.source FROM admin_modules a
  UNION ALL
