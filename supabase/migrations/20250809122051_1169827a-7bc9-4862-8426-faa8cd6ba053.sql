-- Retry: Create tables, bucket, RPC, and RLS policies using DO blocks
...
-- Policies via conditional DO blocks
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'gw_study_scores' AND polname = 'Study score owner manage'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'gw_study_scores' AND polname = 'Collaborators can view shared study scores'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'gw_study_score_collaborators' AND polname = 'Owner manages collaborators'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'gw_study_score_collaborators' AND polname = 'Collaborators can read own collaborator rows'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'gw_sheet_music_annotations' AND polname = 'Study score collaborators can view annotations'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'gw_sheet_music_annotations' AND polname = 'Study score collaborators can insert annotations'
  ) THEN
