-- Standardize error response fields for attendance scan RPCs
-- Frontend expects result.message in AttendanceScanPage and result.error in QRAttendanceScanner,
-- so we return BOTH consistently.
