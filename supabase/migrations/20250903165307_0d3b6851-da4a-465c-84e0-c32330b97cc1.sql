-- First, grant executive board members proper permissions for core modules
...
-- Drop and recreate the get_user_modules function with proper executive permissions
