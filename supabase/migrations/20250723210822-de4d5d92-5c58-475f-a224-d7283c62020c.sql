...
CREATE POLICY "Librarians can manage inventory sessions"
...
USING (
  EXISTS (
    ...
    AND (
      role = 'executive_board' AND executive_board_role = 'librarian'
      OR is_admin = true 
...
-- RLS Policies for inventory entries
CREATE POLICY "Librarians can manage inventory entries"
