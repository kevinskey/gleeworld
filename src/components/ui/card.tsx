...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-xl border-2 border-primary/10 bg-gradient-to-br from-white via-blue-50/30 to-purple-50/20 dark:from-slate-900 dark:via-blue-950/30 dark:to-purple-950/20 text-card-foreground shadow-[0_4px_20px_rgba(33,75,152,0.12)] transition-all duration-300 hover:shadow-[0_12px_40px_rgba(33,75,152,0.2)] hover:border-primary/40 hover:-translate-y-1 hover:scale-[1.01] backdrop-blur-sm relative overflow-hidden before:absolute before:inset-0 before:bg-gradient-to-br before:from-primary/[0.08] before:via-transparent before:to-secondary/[0.06] before:opacity-0 hover:before:opacity-100 before:transition-opacity before:duration-300 before:-z-10 before:pointer-events-none",
      className
    )}
    {...props}
  />
