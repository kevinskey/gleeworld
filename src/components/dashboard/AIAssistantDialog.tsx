...
export const AIAssistantDialog = ({ open, onOpenChange }: AIAssistantDialogProps) => {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl h-[95vh] md:h-[80vh] w-[98vw] md:w-full p-0 gap-0 bg-background">
        {/* Compact Header */}
        <DialogHeader className="px-3 md:px-4 py-2.5 md:py-3 border-b">
        ...
        <Tabs defaultValue="messages" className="flex-1 flex flex-col h-full">
          <div className="px-3 md:px-4 pt-2 pb-2 border-b">
            <TabsList className="grid w-full grid-cols-2 h-10 md:h-9 bg-muted/50">
              <TabsTrigger value="assistant" className="flex items-center gap-1.5 text-sm data-[state=active]:bg-background">
                <Bot className="h-4 w-4 md:h-3.5 md:w-3.5" />
          ...
          <TabsContent value="assistant" className="flex-1 flex flex-col m-0 data-[state=inactive]:hidden">
            ...
            <div className="px-3 md:px-4 py-3 md:py-2 border-t bg-background">
              <div className="flex gap-2">
                <Input
                  ...
                  className="flex-1 h-10 md:h-9 text-sm"
                />
                <Button onClick={handleSendAI} size="icon" className="h-10 w-10 md:h-9 md:w-9">
          ...
          <TabsContent value="messages" className="flex-1 flex flex-col m-0 data-[state=inactive]:hidden">
            ...
            <div className="flex items-center gap-2 px-3 md:px-4 py-2 border-b overflow-x-auto">
              ...
              <div className="flex gap-1.5">
                {MESSAGE_TAGS.map(tag => (
                  <Badge
                    ...
                    className="cursor-pointer text-xs whitespace-nowrap h-7 md:h-6"
              ...
              {filterTags.length > 0 && (
                <Button
                  ...
                  className="h-7 md:h-6 px-2 text-xs whitespace-nowrap ml-auto"
                >
                  Clear
                </Button>
              )}
            ...
            <div className="px-3 md:px-4 py-3 md:py-2 border-t bg-background">
              ...
              <div className="flex items-center gap-2 mb-2 overflow-x-auto">
                <Tag className="h-3.5 w-3.5 md:h-3 md:w-3 text-muted-foreground flex-shrink-0" />
                {MESSAGE_TAGS.map(tag => (
                  <Badge
                    key={tag}
