...
import { Send, MessageSquare, Inbox, Tag, X } from "lucide-react";
...
export const AIAssistantDialog = ({ open, onOpenChange }: AIAssistantDialogProps) => {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl h-[95vh] md:h-[80vh] w-[98vw] md:w-full p-0 gap-0 bg-background flex flex-col">
        {/* Header */}
