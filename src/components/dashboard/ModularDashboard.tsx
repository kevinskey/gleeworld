...
const BASELINE_MODULE_IDS = ['community-hub','music-library','calendar','attendance'];
...
export const ModularDashboard: React.FC<ModularDashboardProps> = ({ hideHeader = false, onExpandChange }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background/95 to-muted/30 relative overflow-visible">
      {/* Dashboard Header */}
      {!hideHeader && (
        <div className="sticky z-40 border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60" style={{ top: 'var(--app-header-offset)' }}>
