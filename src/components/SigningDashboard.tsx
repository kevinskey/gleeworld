...
import { FileText, Clock, CheckCircle, AlertCircle, Send, Eye, Download, Inbox } from "lucide-react";
      ...
      {documents.length === 0 ? (
        <Card className="text-center py-12">
          <CardContent>
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">No documents sent yet</h3>
            <p className="text-gray-500">Your sent contracts will appear here once you start sending them</p>
          </CardContent>
        </Card>
      ) : (
            ...
            {completedDocs.length === 0 ? (
              <Card className="text-center py-8">
                <CardContent>
                  ...
                  <p className="text-gray-500">No completed documents yet</p>
                </CardContent>
              </Card>
            ) : (
