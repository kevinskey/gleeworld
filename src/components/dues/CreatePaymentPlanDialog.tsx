      ...
      <DialogContent className="max-w-md max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <PopoverContent className="w-full p-0">
                <Command>
                  ...
                  <CommandList>
                    ...
                    <CommandGroup>
                      {pendingDuesRecords.map(record => <CommandItem key={record.id} value={`${record.gw_profiles?.full_name || 'Unknown'} ${record.amount} ${record.semester}`} onSelect={() => {
          ...
          <div>
            ...
            <Input id="total_amount" type="number" step="0.01" min="0" value={formData.total_amount} onChange={e => setFormData({
            ...formData,
          ...
          <div>
            ...
            <Select value={formData.installments} onValueChange={value => setFormData({
            ...formData,
            installments: value
          })}>
              <SelectTrigger>
          ...
          <div>
            ...
            <Select value={formData.frequency} onValueChange={value => setFormData({
            ...formData,
            frequency: value
          })}>
              <SelectTrigger>
          ...
          <div className="flex items-center justify-between">
            ...
            <Switch id="auto_debit" checked={formData.auto_debit} onCheckedChange={checked => setFormData({
            ...formData,
            auto_debit: checked
          })} />
          </div>

          {formData.total_amount && formData.installments && <div className="p-3 rounded-lg bg-brand-subtle/20 border border-brand-accent/20">
              ...
              {calculateEndDate() && <div className="text-sm text-muted-foreground">
