      ...
      <div className="container mx-auto px-4 py-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="text-center md:text-left">
            <h3 className="text-lg font-semibold text-white mb-2">Contract Manager</h3>
          ...
          <div className="text-center">
            <h4 className="text-md font-medium text-white mb-2">Quick Links</h4>
          ...
          <div className="text-center md:text-right">
            <h4 className="text-md font-medium text-white mb-2">Support</h4>
            <div className="space-y-1">
              <p className="text-white/70 text-sm">Need help?</p>
              <p className="text-white/70 text-sm">Contact your administrator</p>
            </div>
          </div>
        </div>
