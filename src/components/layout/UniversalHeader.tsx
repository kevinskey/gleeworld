    ...
    <div className="w-full m-0 p-0 fixed top-0 left-0 right-0 z-50 overflow-hidden">
          ...
          <div className="flex items-center gap-1 md:gap-3 lg:gap-5 min-w-0">
            <EnhancedTooltip content="Go to GleeWorld Home" disabled={isMobile || location.pathname === '/admin'} className="z-10">
              <Link to="/" className="flex items-center gap-1.5 hover:scale-105 transition-transform duration-200 relative flex-shrink-0 text-black">
                <div className="relative">
                  <img src="/lovable-uploads/80d39e41-12f3-4266-8d7a-b1d3621bbf58.png" alt="Spelman College Glee Club" className="w-8 h-8 sm:w-8 sm:h-8 md:w-10 md:h-10 lg:w-12 lg:h-12 object-contain flex-shrink-0 drop-shadow-md" />
                </div>
                <span style={{
                    color: '#0f172a',
                    fontFamily: "'Cinzel', serif",
                    letterSpacing: '0.02em'
                  }} className="text-base sm:text-base md:text-lg xl:text-2xl whitespace-nowrap relative text-black font-medium lg:text-3xl">
                  GleeWorld
          ...
          <div className="flex items-center gap-0.5 sm:gap-1.5 md:gap-2.5 lg:gap-5">
            ...
            {user && <EnhancedTooltip content={isMessengerOpen ? "Close Messenger" : "Send Email/SMS"}>
                <Button variant="ghost" size="sm" onClick={toggleMessenger} className={`h-10 w-10 sm:h-10 sm:w-10 md:h-12 md:w-12 lg:h-20 lg:w-20 p-0 hover:bg-gray-100 rounded-full text-foreground ${isMessengerOpen ? 'bg-gray-100' : ''}`} type="button">
                  <Mail className="h-7 w-7 sm:h-8 sm:w-8 md:h-10 md:w-10 lg:h-16 lg:w-16" />
                </Button>
              </EnhancedTooltip>}
            ...
            {user && <>
                ...
                {userProfile?.is_super_admin && <DropdownMenu>
                   <DropdownMenuTrigger asChild>
                      <Button variant="ghost" size="sm" className="h-10 w-10 sm:h-10 sm:w-10 md:h-12 md:w-12 lg:h-20 lg:w-20 p-0 hover:bg-gray-100 rounded-full text-foreground" type="button">
                        <LayoutDashboard className="h-7 w-7 sm:h-8 sm:w-8 md:h-10 md:w-10 lg:h-16 lg:w-16" />
                      </Button>
                   </DropdownMenuTrigger>
                ...
                {!hasExecBoardPerms && <EnhancedTooltip content="Add Module to Dashboard">
                    <Button variant="ghost" size="sm" onClick={() => navigate('/dashboard/member?addModule=true')} className="hidden sm:flex h-10 w-10 sm:h-10 sm:w-10 md:h-12 md:w-12 lg:h-20 lg:w-20 p-0 hover:bg-gray-100 rounded-full text-foreground" type="button">
                      <Plus className="h-7 w-7 sm:h-8 sm:w-8 md:h-10 md:w-10 lg:h-16 lg:w-16" />
                    </Button>
                  </EnhancedTooltip>}
                ...
                <div className="hidden sm:block">
                  <EnhancedTooltip content="Glee Cam - Quick Capture">
                    ...
                    }} className="h-10 w-10 sm:h-10 sm:w-10 md:h-12 md:w-12 lg:h-20 lg:w-20 p-0 hover:bg-gray-100 rounded-full text-foreground" type="button">
                      <Camera className="h-7 w-7 sm:h-8 sm:w-8 md:h-10 md:w-10 lg:h-16 lg:w-16" />
                    </Button>
                  </EnhancedTooltip>
                </div>
                ...
                <EnhancedTooltip content="Members Quick Access">
                  <Button variant="ghost" size="sm" onClick={() => setIsQuickActionsOpen(prev => !prev)} className="h-10 w-10 sm:h-10 sm:w-10 md:h-12 md:w-12 lg:h-20 lg:w-20 p-0 hover:bg-gray-100 rounded-full text-foreground" type="button">
                    <Key className="h-7 w-7 sm:h-8 sm:w-8 md:h-10 md:w-10 lg:h-16 lg:w-16" />
                  </Button>
                </EnhancedTooltip>
               ...
               <DropdownMenu>
                   <EnhancedTooltip content="Profile menu">
                      <DropdownMenuTrigger asChild>
                         <Button variant="ghost" className="relative h-10 w-10 sm:h-10 sm:w-10 md:h-12 md:w-12 lg:h-20 lg:w-20 rounded-full p-0 hover:bg-gray-100 text-foreground" type="button">
                           <Avatar className="h-9 w-9 sm:h-9 sm:w-9 md:h-11 md:w-11 lg:h-16 lg:w-16 border border-border">
