            ...
            {user && <>
               ...
               <DropdownMenu>
                   <EnhancedTooltip content="Profile menu">
                      <DropdownMenuTrigger asChild>
                         <Button variant="ghost" className="relative h-12 w-12 sm:h-12 sm:w-12 md:h-16 md:w-16 lg:h-20 lg:w-20 rounded-full p-0 hover:bg-gray-100 text-foreground" type="button">
                           <Avatar className="h-11 w-11 sm:h-11 sm:w-11 md:h-14 md:w-14 lg:h-16 lg:w-16 border border-border">
