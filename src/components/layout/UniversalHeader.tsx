                ...
                <div className="flex items-center gap-2">
                  ...
                  {pageName !== 'GleeWorld' && (
                    <>
                      ...
                      <span className="text-white font-medium text-sm sm:text-base md:text-lg truncate max-w-32 sm:max-w-48 md:max-w-64 bg-slate-900 pl-[5px] pr-2 py-0.5 rounded-md">
                        {pageName}
                      </span>
                    </>
                  )}
