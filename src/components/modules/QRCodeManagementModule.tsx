    ...
    <div className="h-full p-4 sm:p-6 academy-neutral" style={{ background: '#f8f9fb' }}>
      ...
      <Tabs defaultValue="generator" className="w-full">
        <TabsList className="w-full h-auto p-1 rounded-xl mb-4 grid grid-cols-3 sm:grid-cols-5 gap-1" style={{ background: '#e2e8f0' }}>
          <TabsTrigger 
            value="generator" 
            className="flex-1 flex items-center justify-center gap-1.5 py-2.5 px-2 text-base rounded-lg data-[state=active]:bg-white data-[state=active]:shadow-sm"
            style={{ color: '#334155' }}
          >
          ...
          <TabsTrigger 
            value="history" 
            className="hidden sm:flex flex-1 items-center justify-center gap-1.5 py-2.5 px-2 text-base rounded-lg data-[state=active]:bg-white data-[state=active]:shadow-sm"
            style={{ color: '#334155' }}
          >
        ...
        <div className="sm:hidden grid grid-cols-2 gap-2 mb-4">
          <TabsList className="w-full h-auto p-1 bg-muted/50 rounded-xl">
            <TabsTrigger 
              value="history" 
              className="w-full flex items-center justify-center gap-1.5 py-2 px-2 text-base rounded-lg data-[state=active]:bg-background data-[state=active]:shadow-sm"
            >
              <History className="h-4 w-4" />
              History
            </TabsTrigger>
