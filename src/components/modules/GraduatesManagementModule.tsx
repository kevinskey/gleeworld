...
import { GraduatesPageBuilder } from "@/components/graduates/GraduatesPageBuilder";
import { GraduatesFormBuilder } from "@/components/graduates/GraduatesFormBuilder";
import { ModuleProps } from "@/types/unified-modules";
export const GraduatesManagementModule = ({
  user,
  isFullPage = false
}: ModuleProps) => {
  ...
  return <div className={isFullPage ? "container mx-auto px-4 py-8 space-y-6" : "space-y-6"}>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Create and manage all graduates portal content from one place
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Tabs defaultValue="page-builder" className="w-full">
            ...
            <TabsContent value="page-builder" className="mt-6">
              <GraduatesPageBuilder />
            </TabsContent>

            <TabsContent value="forms" className="mt-6">
              <GraduatesFormBuilder />
            </TabsContent>
          </Tabs>
        </CardContent>
      </Card>
