...
export const FAQSlider = () => {
  ...
  return (
    <section className="w-full relative overflow-hidden pt-[96px] pb-12 md:pt-[116px] md:pb-8 lg:pt-[136px] lg:pb-10 min-h-[250px] md:min-h-[350px] fixed top-0 left-0 z-30">
