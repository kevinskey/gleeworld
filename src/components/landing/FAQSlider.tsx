           ...
           <div className="h-[320px] md:h-[320px] lg:h-[360px] flex flex-col justify-start space-y-4 max-w-4xl mx-auto">
             {!isFooterCard ? (
               <>
                 ...
                 <div className="bg-background/60 backdrop-blur-sm border border-border rounded-lg p-4 md:p-6 lg:p-8 shadow-sm flex flex-col justify-start h-[100px] md:h-[100px] lg:h-[120px]">
                 ...
                 <div className="bg-primary/5 backdrop-blur-sm border border-primary/20 rounded-lg p-4 md:p-6 lg:p-8 shadow-sm flex flex-col justify-start h-[200px] md:h-[200px] lg:h-[220px]">
                   <div className="flex items-center space-x-2 mb-3">
              ...
              <div className="bg-gradient-to-r from-primary to-primary/80 rounded-lg p-3 md:p-6 lg:p-8 backdrop-blur-sm border border-white/20 shadow-lg transition-all duration-500 ease-in-out flex flex-col justify-center h-[296px] md:h-[296px] lg:h-[336px]">
