...
export const FAQSlider = () => {
  ...
  return (
    <section className="w-full relative overflow-hidden pt-[96px] pb-12 md:pt-40 md:pb-16 lg:pt-48 lg:pb-20 min-h-[250px] md:min-h-[450px] fixed top-0 left-0 z-30">
