          ...
          {/* Fixed height container for consistent sizing */}
           <div className="h-[280px] md:h-[320px] lg:h-[360px] flex flex-col justify-start space-y-4 max-w-4xl mx-auto">
             {!isFooterCard ? (
              ...
              <div className="bg-gradient-to-r from-primary to-primary/80 rounded-lg p-6 md:p-8 lg:p-10 backdrop-blur-sm border border-white/20 shadow-lg transition-all duration-500 ease-in-out flex flex-col justify-center min-h-full">
                <h3 className="text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold text-primary-foreground mb-4 text-center leading-tight">
                  Good luck on your auditions ladies!
                </h3>
                <p className="text-base md:text-lg lg:text-xl text-primary-foreground/90 mb-2 text-center">
                  To stay up to date, follow us on social media at
                </p>
                <p className="text-xl md:text-2xl lg:text-3xl xl:text-4xl font-bold text-primary-foreground text-center">
                  @Spelmanglee
                </p>
              </div>
            )}
