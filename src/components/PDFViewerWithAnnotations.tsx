...
const [engine, setEngine] = useState<'google' | 'react'>('google');
  ...
  // Scrolling never turns pages — vertical scroll only pans within the
  // current page. Page turns are left/right tap zones and swipes only
  // (musicians kept accidentally flipping pages while scrolling a score).
