...
export const TypewriterGreeting = ({ 
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm animate-in fade-in duration-300">
      <div className="relative max-w-2xl mx-4 p-8 sm:p-12 rounded-2xl bg-gradient-to-br from-[hsl(var(--brand-navy))] via-[#1a3a5c] to-[hsl(var(--brand-navy))] border border-white/20 shadow-2xl">
        {/* Close button */}
        <Button
          variant="ghost"
          size="icon"
