...
interface MetalHeaderDashboardProps {
  ...
  showMessages?: boolean; // Whether messages panel is visible
...
export const MetalHeaderDashboard = ({
  ...
  return <div className="space-y-4 relative min-h-screen w-full max-w-7xl mx-auto px-1 sm:px-4 md:px-6 lg:px-8 pt-4">
