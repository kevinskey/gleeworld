...
const LH100_MODULES: WeeklyModule[] = [
  ...
  },
  {
    ...
    description: 'Feast day celebration and preparation.',
    start_date: '2026-02-02',
    end_date: '2026-02-02',
    is_active: false,
    is_locked: false,
    learning_objectives: [
      'Understand the significance of this Feast',
      'Prepare special liturgical elements',
      'Plan music appropriate for the celebration'
    ],
    resources: [
      { id: 'lh4-1', title: 'Feast Day Overview', type: 'reading', duration: '25 min', completed: false },
  ...
  },
  {
    ...
    week_number: 7,
    title: 'Ash Wednesday',
    description: 'Major observance marking the beginning of Lent.',
    ...
    learning_objectives: [
      ...
      'Plan penitential music and prayers'
    ],
    resources: [
      { id: 'lh7-1', title: 'Lenten Preparation Guide', type: 'reading', duration: '30 min', completed: false },
      { id: 'lh7-2', title: 'Liturgy Planning Guide', type: 'document', completed: false },
      { id: 'lh7-3', title: 'Penitential Music Selection', type: 'audio', duration: '20 min', completed: false },
    ],
    completion_percentage: 0
  },
  {
    ...
    description: 'Sunday liturgical preparation during Lenten season.',
    start_date: '2026-02-22',
    end_date: '2026-02-22',
    is_active: false,
    is_locked: false,
    learning_objectives: [
      'Embrace Lenten themes in liturgy',
      'Reflect on repentance and renewal',
    ...
    resources: [
      ...
      { id: 'lh8-3', title: 'Lenten Music Selection', type: 'audio', duration: '15 min', completed: false },
    ],
    completion_percentage: 0
  },
  {
    ...
    is_locked: false,
    learning_objectives: [
      'Continue Lenten journey through liturgy',
      'Reflect on transfiguration themes',
      'Plan music ministry for the celebration'
    ],
    resources: [
  ...
  },
  {
    ...
    is_locked: false,
    learning_objectives: [
      'Deepen Lenten reflection',
      'Prepare meaningful liturgy',
      'Plan music ministry for the celebration'
    ],
    resources: [
  ...
  },
  {
    ...
    description: 'Sunday of rejoicing in the midst of Lent.',
    ...
    learning_objectives: [
      ...
      'Balance penitential and joyful themes',
      'Plan music reflecting hope and joy'
    ],
    resources: [
      { id: 'lh11-1', title: 'Laetare Sunday Overview', type: 'reading', duration: '20 min', completed: false },
  ...
  },
  {
    ...
    description: 'Solemnity honoring Saint Joseph.',
  ...
  },
  {
    ...
    is_locked: false,
    learning_objectives: [
      'Prepare for the approach of Holy Week',
      'Deepen penitential reflection',
      'Plan music ministry for the celebration'
    ],
    resources: [
  ...
  },
  {
    ...
    description: 'Solemnity celebrating the announcement to Mary.',
    ...
    learning_objectives: [
      ...
      'Prepare special Marian liturgy',
      'Plan music celebrating Mary\'s fiat'
    ],
    resources: [
      ...
      { id: 'lh14-3', title: 'Marian Music Selection', type: 'audio', duration: '15 min', completed: false },
    ],
    completion_percentage: 0
  },
  {
    ...
    is_locked: false,
    learning_objectives: [
      'Prepare for the Passion narrative',
      'Plan procession and liturgical elements',
      'Select music for triumph and suffering'
    ],
    resources: [
      { id: 'lh15-1', title: 'Holy Week Overview', type: 'reading', duration: '30 min', completed: false },
      { id: 'lh15-2', title: 'Liturgy Planning Guide', type: 'document', completed: false },
      { id: 'lh15-3', title: 'Palm Sunday Music', type: 'audio', duration: '20 min', completed: false },
    ],
    completion_percentage: 0
  },
  {
    ...
    description: 'Sacred Paschal Triduum - Evening Mass of the Lord\'s Supper.',
    ...
    learning_objectives: [
      ...
      'Plan washing of feet liturgy',
      'Select music for service and sacrifice'
    ],
    resources: [
      { id: 'lh16-1', title: 'Triduum Preparation', type: 'reading', duration: '35 min', completed: false },
      { id: 'lh16-2', title: 'Liturgy Planning Guide', type: 'document', completed: false },
      { id: 'lh16-3', title: 'Holy Thursday Music', type: 'audio', duration: '25 min', completed: false },
    ],
    completion_percentage: 0
  },
  {
    ...
    description: 'Sacred Paschal Triduum - Celebration of the Lord\'s Passion.',
    start_date: '2026-04-03',
    end_date: '2026-04-03',
    is_active: false,
    is_locked: false,
    learning_objectives: [
      'Prepare for the Passion liturgy',
      'Plan veneration of the Cross',
      'Select solemn music for the day'
    ],
    resources: [
      ...
      { id: 'lh17-3', title: 'Good Friday Music', type: 'audio', duration: '25 min', completed: false },
    ],
    completion_percentage: 0
  },
  {
    ...
    week_number: 18,
    title: 'Holy Saturday',
    description: 'Sacred Paschal Triduum - Day of waiting and preparation.',
    ...
    learning_objectives: [
      ...
      'Understand the significance of waiting',
      'Plan Vigil liturgical elements'
    ],
    resources: [
      { id: 'lh18-1', title: 'Holy Saturday Reflection', type: 'reading', duration: '25 min', completed: false },
      { id: 'lh18-2', title: 'Easter Vigil Planning', type: 'document', completed: false },
  ...
  },
  {
    ...
    description: 'Solemnity - The greatest feast of the Church year.',
    ...
    learning_objectives: [
      ...
      'Prepare triumphant Easter liturgy',
      'Plan glorious Easter music'
    ],
    resources: [
      { id: 'lh19-1', title: 'Easter Celebration Guide', type: 'reading', duration: '25 min', completed: false },
  ...
  },
  {
    ...
    description: 'Sunday celebrating God\'s mercy.',
    start_date: '2026-04-12',
    end_date: '2026-04-12',
    is_active: false,
    is_locked: false,
    learning_objectives: [
      'Explore Divine Mercy spirituality',
      'Prepare liturgy focusing on mercy',
      'Plan music celebrating God\'s mercy'
    ],
    resources: [
  ...
  },
  {
    ...
    description: 'Sunday in the Easter season.',
    start_date: '2026-04-19',
    end_date: '2026-04-19',
    is_active: false,
    is_locked: false,
    learning_objectives: [
      'Continue Easter celebration',
      'Prepare joyful liturgy',
  ...
  },
  {
    ...
    description: 'Feast honoring the author of the earliest Gospel.',
