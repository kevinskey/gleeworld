...
export const RequirementsEditor: React.FC<Props> = ({ syllabusId, onSave }) => {
  ...
  const fetchRequirements = async () => {
    ...
    try {
      const { data, error } = await supabase
        .from('gw_course_requirements' as any)
        .select('*')
            ...
            >
              ...
              <div className="flex-1">
                <Textarea
                  ...
                  placeholder="Describe the requirement or assignment..."
                  rows={2}
                />
              </div>
              ...
              <div className="w-24">
                <div className="relative">
                  <Input
                    type="number"
                    value={requirement.weight_percentage}
