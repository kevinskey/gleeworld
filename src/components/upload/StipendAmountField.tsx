  ...
  return (
    <div className="space-y-3">
      ...
      {templateId && (receiptTotal > 0 || stipendValue > 0) && (
        <div className="flex items-center justify-between text-sm p-3 bg-brand-700/20 rounded-lg border border-brand-400/30">
          ...
          <div className="text-right">
            ...
            <div className="text-lg font-semibold text-brand-300 flex items-center gap-1">
