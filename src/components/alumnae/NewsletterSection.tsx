...
export const NewsletterSection = () => {
  ...
  const [spotlights, setSpotlights] = useState<{ alumnae?: Spotlight; student?: Spotlight }>({});
  ...
  const fetchNewsletterData = async () => {
    try {
      ...
      if (newsletterData) {
        ...
        setSpotlights({ alumnae: alumnaeSpotlight, student: studentSpotlight });
  ...
  const SpotlightCard = ({ spotlight, type }: { spotlight?: Spotlight; type: string }) => (
    <Card className="animate-fade-in">
      <CardHeader>
        <CardTitle className="text-base">{type} Spotlight</CardTitle>
      </CardHeader>
        ...
        {spotlight ? (
          <>
            ...
            <div className="text-center">
              ...
              {spotlight.title && <p className="text-sm text-muted-foreground">{spotlight.title}</p>}
          ...
          <p className="text-sm text-muted-foreground text-center">No spotlight this month</p>
        )}
      </CardContent>
    </Card>
  );
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            {announcements.length > 0 ? (
              ...
              <p className="text-sm text-muted-foreground">No announcements this month</p>
            )}
          </CardContent>
        </Card>
      </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            {upcomingEvents.length > 0 ? (
              ...
              <p className="text-sm text-muted-foreground">No upcoming performances scheduled</p>
            )}
          </CardContent>
        </Card>
