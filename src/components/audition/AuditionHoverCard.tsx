      ...
      <div className="fixed top-16 left-4 right-4 z-40 max-w-[calc(100vw-2rem)] pt-[10px] h-[812px]">
        <Link to="/auditions">
          <Button 
            variant="branded" 
            size="sm"
            className="w-full max-w-xs mx-auto px-6 py-4 rounded-lg text-sm font-bold touch-manipulation flex items-center justify-center bg-gradient-to-b from-blue-500 via-blue-600 to-blue-700 hover:from-blue-400 hover:via-blue-500 hover:to-blue-600 text-white border-2 border-blue-500 shadow-[inset_0_1px_0_rgba(255,255,255,0.2),inset_0_-1px_0_rgba(0,0,0,0.3),0_4px_8px_rgba(0,0,0,0.3)] hover:shadow-[inset_0_1px_0_rgba(255,255,255,0.3),inset_0_-1px_0_rgba(0,0,0,0.4),0_6px_12px_rgba(0,0,0,0.4)] transition-all duration-300 ease-out hover:scale-105 animate-fade-in"
          >
