    ...
    <div className="fixed top-32 left-1/2 transform -translate-x-1/2 z-40 pt-[10px] pb-8 h-[812px]">
      <Link to="/auditions">
        <Button 
          variant="branded" 
          size="lg"
          className="px-16 py-8 rounded-full text-xl font-bold scale-150 md:scale-125 lg:scale-150 bg-white/10 hover:bg-white/20 text-white shadow-2xl border-2 border-white/20 backdrop-blur-xl transition-all duration-500 ease-out hover:scale-[1.6] md:hover:scale-[1.35] lg:hover:scale-[1.6] hover:shadow-[0_0_40px_rgba(255,255,255,0.5)] hover:border-white/50 animate-fade-in group"
        >
