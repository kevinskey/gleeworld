    ...
    <div className="fixed top-32 left-1/2 transform -translate-x-1/2 z-40 pt-[10px] pb-8">
      <Link to="/auditions">
        <Button 
          variant="branded" 
          size="lg"
          className="px-12 py-8 rounded-lg text-lg font-bold scale-125 md:scale-100 lg:scale-125 bg-gradient-to-b from-brand-blue-light via-brand-blue-light/90 to-brand-blue-dark hover:from-brand-blue-light/80 hover:via-brand-blue-light/70 hover:to-brand-blue-dark/90 text-white border-2 border-brand-blue-light shadow-[inset_0_2px_0_rgba(255,255,255,0.2),inset_0_-2px_0_rgba(0,0,0,0.3),0_6px_16px_rgba(0,0,0,0.3)] hover:shadow-[inset_0_2px_0_rgba(255,255,255,0.3),inset_0_-2px_0_rgba(0,0,0,0.4),0_8px_20px_rgba(0,0,0,0.4)] transition-all duration-300 ease-out hover:scale-[1.35] md:hover:scale-[1.1] lg:hover:scale-[1.35] animate-fade-in group"
        >
