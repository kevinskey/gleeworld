...
export const HeaderMusicPlayer = ({ className = "", isExpanded = false, onToggleExpanded }: HeaderMusicPlayerProps) => {
  ...
  if (isMobile) {
    ...
    return (
      <div
        className="fixed left-0 right-0 bg-gradient-to-r from-amber-900 via-amber-800 to-amber-900 backdrop-blur-lg border-b-4 border-amber-600 shadow-2xl z-[105] min-h-[60px] flex items-center px-4 gap-3"
        style={{
