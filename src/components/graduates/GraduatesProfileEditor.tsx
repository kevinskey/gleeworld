...
interface GraduatesProfileEditorProps {
  user: any;
  open: boolean;
...
export const GraduatesProfileEditor = ({ user, open, onOpenChange, onSuccess }: GraduatesProfileEditorProps) => {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Update graduate information and preferences
          </DialogDescription>
        </DialogHeader>
          ...
          <TabsContent value="settings" className="space-y-4 mt-4">
            ...
            <div className="flex items-center justify-between pt-2 border-t">
              <div className="space-y-0.5">
                ...
                <p className="text-sm text-muted-foreground">Display on featured graduates section</p>
              </div>
              <Switch
                id="is_featured"
