...
interface Spotlight {
  id: string;
  spotlight_type: 'graduates' | 'student';
  name: string;
  title?: string;
  description?: string;
  photo_url?: string;
  ...
  const fetchNewsletterData = async () => {
    try {
      ...
      if (newsletterData) {
        ...
        const graduatesSpotlight = spotlightsData?.find(s => s.spotlight_type === 'graduates') as Spotlight | undefined;
        const studentSpotlight = spotlightsData?.find(s => s.spotlight_type === 'student') as Spotlight | undefined;
        setSpotlights({
          graduates: graduatesSpotlight,
    ...
    return <Card className="animate-fade-in">
        ...
        <CardContent className="text-center py-8">
          ...
          <p className="text-sm text-muted-foreground">
            Graduates liaisons and admins can create and publish newsletters using the Management Panel below.
          </p>
        </CardContent>
      </Card>;
  }
  ...
  return <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-10 gap-6">
        ...
        <div className="lg:col-span-4 space-y-6">
          {/* Graduates Spotlight */}
          <SpotlightCard spotlight={spotlights.graduates} type="Graduates" />
        ...
        <Card className="bg-gradient-to-br from-purple-500 to-purple-600 text-white">
          <CardContent className="p-6 text-center space-y-3">
            ...
            <h3 className="font-semibold text-lg">Graduates Merch Store</h3>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            {/* PDF Preview */}
            {securePdfUrl && (
              <div className="border-2 border-primary/20 rounded-xl overflow-hidden bg-gradient-to-br from-purple-50 to-blue-50 dark:from-purple-950/20 dark:to-blue-950/20 shadow-lg">
                <FastPDFViewer 
                  pdfUrl={securePdfUrl}
