  ...
  const [templates, setTemplates] = useState<Template[]>([
    {
      ...
      category: "Service",
      content: "This Service Agreement is entered into between {{client_name}} and {{service_provider}}...",
      fields: ["client_name", "service_provider", "start_date", "payment_amount"],
    ...
    },
    {
      ...
      category: "Legal",
      content: "This Non-Disclosure Agreement is between {{party_1}} and {{party_2}}...",
      fields: ["party_1", "party_2", "effective_date", "duration"],
    ...
    },
    {
      ...
      category: "HR",
      content: "This Employment Agreement is between {{company_name}} and {{employee_name}}...",
      fields: ["company_name", "employee_name", "position", "salary", "start_date"],
