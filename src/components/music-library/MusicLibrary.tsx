    ...
    <>
      ...
      <div className="container mx-auto px-2 sm:px-4 lg:px-6 pt-4 md:pt-6 pb-6">
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-12 gap-4 lg:gap-6 min-h-[calc(100vh-8rem)] lg:h-[calc(100vh-5rem)]">
          ...
          <div className={`${selectedPdf ? 'lg:col-span-5' : 'lg:col-span-5'} space-y-4 lg:h-full lg:overflow-y-auto lg:pr-1 order-2 lg:order-1`}>
            {/* Study Scores */}
          ...
          <div className={`${selectedPdf ? 'lg:col-span-7' : 'lg:col-span-7'} flex flex-col min-h-[60vh] lg:h-full overflow-hidden lg:pl-1 order-1 lg:order-2`}>
