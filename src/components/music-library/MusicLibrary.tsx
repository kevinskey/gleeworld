        ...
        <PanelGroup direction="horizontal" className="min-h-[calc(100vh-8rem)] lg:h-[calc(100vh-5rem)]">
          ...
          <Panel defaultSize={leftColumnCollapsed ? 100 : selectedPdf ? 80 : 65} className="flex flex-col items-start min-h-[60vh] lg:h-full overflow-hidden">
            ...
            {selectedPdf ? <div className="flex-1 overflow-hidden rounded-lg lg:rounded-xl">
                ...
                <img src="/lovable-uploads/7dee05e5-4f0d-4fa1-9260-b97fd383d709.png" alt="Glee World Music Library landing image" className="absolute inset-0 w-full h-full object-cover" loading="lazy" />
              </div>}
          </Panel>
        </PanelGroup>
      </div>
