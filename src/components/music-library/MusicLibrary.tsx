  ...
  return <>
      ...
      <div className="w-full overflow-hidden page-container">
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-12 card-spacing min-h-[calc(100vh-8rem)] lg:h-[calc(100vh-5rem)]">
          ...
          <div className={`${selectedPdf ? 'lg:col-span-6' : 'lg:col-span-12'} section-spacing lg:h-full lg:overflow-y-auto lg:pr-1 order-2 lg:order-1 w-full overflow-hidden`}>
            {/* Study Scores */}
          ...
          <div className={`${selectedPdf ? 'lg:col-span-6' : 'lg:col-span-0'} flex flex-col min-h-[60vh] lg:h-full overflow-hidden lg:pl-1 order-1 lg:order-2 w-full`}>
