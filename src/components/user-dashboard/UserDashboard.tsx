          ...
          <div className="bg-gradient-to-r from-purple-600 via-blue-600 to-indigo-700 rounded-xl shadow-lg p-4">
            <div className="text-center">
              ...
              <p className="text-white/80 text-sm mt-1">
                {[profile?.exec_board_role, profile?.voice_part].filter(Boolean).join(', ') || getUserTitle()} • Spelman College Glee Club • Member since {profile?.created_at ? format(new Date(profile.created_at), 'MMMM yyyy') : 'Recently'}
              </p>
            </div>
          </div>
