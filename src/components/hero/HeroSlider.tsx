        ...
        return (
          <>
            ...
            <img
              ...
              className="hidden md:block w-full h-auto block brightness-95"
            ...
            <img
              ...
              alt={slide.title || 'Hero slide'}
              className="hidden sm:block md:hidden w-full h-auto block brightness-95"
              style={{ objectPosition }}
              onError={(e) => {
                (e.target as HTMLImageElement).src = defaultImage;
              }}
            ...
            <img
              ...
              alt={slide.title || 'Hero slide'}
              className="block sm:hidden w-full h-auto block brightness-95"
              style={{ objectPosition }}
              onError={(e) => {
                (e.target as HTMLImageElement).src = defaultImage;
              }}
