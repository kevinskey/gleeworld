...
export const DashboardFeaturesCarousel: React.FC = () => {
  ...
  return (
    <Card className="border-border bg-background/50 backdrop-blur-sm shadow-sm overflow-hidden">
          ...
          <Carousel className="w-full">
            <CarouselContent>
              {slides.length > 0 ? (
                ...
                <CarouselItem>
                  <div className="aspect-[4/3] md:aspect-[16/7] w-full flex items-center justify-center bg-muted">
