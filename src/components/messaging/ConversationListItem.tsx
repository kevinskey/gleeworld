...
export const ConversationListItem: React.FC<ConversationListItemProps> = ({
  ...
  return <div onClick={onClick} className={cn('flex items-center gap-1.5 md:gap-3 cursor-pointer transition-colors border-b border-border/50', 'hover:bg-accent/5', isSelected ? 'bg-[hsl(var(--message-header))]/15 border-l-[3px] md:border-l-4 border-l-[hsl(var(--message-header))] p-2 md:p-3 pl-2.5 md:pl-4' : 'p-1.5 md:p-3')}>
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-baseline justify-between gap-1 md:gap-2 mb-0.5">
          <h3 className="font-semibold text-foreground truncate text-[5.5px] md:text-base">{name}</h3>
