  ...
  return <>
      <ContextMenu>
        <ContextMenuTrigger asChild>
          <div className="w-4/5 flex justify-center" onTouchStart={handleTouchStart} onTouchEnd={handleTouchEnd} onTouchMove={handleTouchMove} onContextMenu={e => {
        ...
        {(canEdit || canDelete) && <ContextMenuContent className="w-48">
            ...
            {canEdit && <ContextMenuItem onClick={onEdit} className="gap-2">
      ...
      {showContextMenu && (canEdit || canDelete) && <div className="fixed inset-0 z-50 md:hidden" onClick={() => setShowContextMenu(false)}>
          <div className="absolute bg-popover border border-border rounded-lg shadow-lg p-1 min-w-[180px]" style={{
      ...
      <AlertDialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle className="text-primary-foreground">Delete Event</AlertDialogTitle>
