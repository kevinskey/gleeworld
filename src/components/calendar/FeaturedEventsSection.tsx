...
export const FeaturedEventsSection = ({ events }: FeaturedEventsSectionProps) => {
  ...
  return (
    <>
      <div className="mb-8">
        <h3 className="text-xl font-bold text-[hsl(var(--brand-navy))] mb-4 flex items-center gap-2">
              ...
              >
                ...
                <div className="relative h-36 overflow-hidden">
                  ...
                  <div className="absolute top-2 left-2 bg-white/95 backdrop-blur-sm rounded-lg px-2 py-1 shadow-md">
                    <div className="text-xs font-bold text-[hsl(var(--brand-navy))] uppercase">
                      {format(eventDate, 'MMM')}
                    </div>
                    <div className="text-lg font-bold text-[hsl(var(--brand-navy))] leading-tight">
                      {format(eventDate, 'd')}
                    </div>
                  </div>
                </div>
                ...
                {/* Event Info */}
                <div className="p-3">
                  <h4 className="font-semibold text-[hsl(var(--brand-navy))] text-sm line-clamp-2 mb-2 group-hover:text-[#002244]">
                    {event.title}
                  </h4>
