      ...
      <div className="bg-white rounded-xl shadow-lg p-6 sm:p-8">
        <div className="flex items-center justify-center py-12">
          <div className="flex flex-col items-center gap-4">
            <div className="w-12 h-12 border-4 border-[hsl(var(--brand-navy))] border-t-transparent rounded-full animate-spin" />
    ...
    return (
      <div className="bg-white rounded-xl shadow-lg p-6 sm:p-8">
        <div className="flex flex-col items-center justify-center py-12 text-center">
          <div className="w-16 h-16 bg-[hsl(var(--brand-navy))]/10 rounded-full flex items-center justify-center mb-4">
            <CalendarIcon className="h-8 w-8 text-[hsl(var(--brand-navy))]" />
          </div>
          <h3 className="text-xl font-semibold text-[hsl(var(--brand-navy))] mb-2">No Public Events Found</h3>
          <p className="text-muted-foreground max-w-md mb-6">
            There are currently no upcoming public events to display. Check back soon for updates!
          </p>
          <Button 
            onClick={() => fetchEvents()} 
            className="bg-[hsl(var(--brand-navy))] hover:bg-[#002244] text-white"
          >
            Refresh Events
          </Button>
        </div>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <div className="min-w-[120px] text-center">
              <h2 className="text-xl sm:text-3xl md:text-4xl font-bold text-[hsl(var(--brand-navy))]">
            ...
            <Button
              ...
              size="sm"
              onClick={goToToday}
              className="ml-2 text-[hsl(var(--brand-navy))] hover:bg-[hsl(var(--brand-navy))]/10"
            >
              Today
            </Button>
          </div>
