            ...
            <>
              ...
              {publicEvents.length > 0 && (
                <div className="space-y-3">
                  ...
                  {publicEvents.map((event) => (
                    <EventCard key={event.id} event={event} onEventClick={onEventClick} formatEventTime={formatEventTime} />
                  ))}
                </div>
              )}
              ...
              {myEvents.length > 0 && (
                <div className="space-y-3">
                  ...
                  {myEvents.map((event) => (
                    <EventCard key={event.id} event={event} onEventClick={onEventClick} formatEventTime={formatEventTime} isPersonal />
                  ))}
                </div>
              )}
            </>
...
const EventCard = ({ event, onEventClick, formatEventTime, isPersonal }: EventCardProps) => (
  <div
