    ...
    <div className="space-y-4 md:space-y-6 p-4 md:p-0">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{formatCurrency(overview?.totalBudgetAmount || 0)}</div>
            <p className="text-xs text-muted-foreground">
              {overview?.totalBudgets || 0} budgets • {overview?.budgetsAtRisk || 0} at risk
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{(overview?.budgetUtilization || 0).toFixed(1)}%</div>
            <p className="text-xs text-muted-foreground">
