...
const STANDARD_POLICIES = {
  academic_honesty_policy: `At the heart of Spelman College's mission is academic excellence, along with the development of intellectual, ethical and leadership qualities. All members of the academic community are expected to follow the basic standards of honesty and integrity as outlined in the Spelman College Code of Conduct.`,
  disability_statement: `Spelman College is committed to ensuring the full participation of all students in its programs. If you have a documented disability, contact the Student Access Center (SAC) at 404-270-5289. Located in MacVicar Hall, Room 106.`,
...
export const SYLLABUS_DEFAULTS: Record<string, SyllabusDefaults> = {
  'MUS 070': {
    ...
    term: 'Spring 2026',
    credits: 1,
    class_time: 'M/W/F 12:00 PM - 1:15 PM',
    ...
    purpose: 'The Spelman College Glee Club is the premier choral ensemble of Spelman College with over 100 years of musical excellence. Members develop vocal technique, musicianship, and performance skills while representing the college at concerts, tours, and special events.',
    course_model: null,
  ...
  'MUS 240': {
    ...
    term: 'Spring 2026',
    credits: 3,
    class_time: 'T/Th 9:30 AM - 10:45 AM',
  ...
  'GLEE 101': {
    ...
    term: 'Spring 2026',
    credits: 1,
    class_time: 'Fridays 2:00 PM - 3:30 PM',
