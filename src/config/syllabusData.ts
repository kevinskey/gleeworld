...
export const SYLLABUS_DATA: Record<string, CourseSyllabus> = {
  ...
  'MUS 240': {
    ...
    assignments: [
      { name: 'Listening Journals', points: '100 pts (10 × 10 pts)', description: 'Weekly 250–300 word essays connecting listening examples to cultural context.' },
      { name: 'Research Project', points: '150 pts', description: 'Proposal, annotated bibliography, and final online presentation.' },
      { name: 'AI Group Project', points: '100 pts', description: 'Collaborative exploration of AI and African American music in six teams. Weekly updates + deep dive sessions. Final Showcase in Week 15.' },
      { name: 'Midterm Exam', points: '100 pts', description: 'Listening identification + essays on styles and cultural context.' },
      { name: 'Final Reflection Essay', points: '50 pts', description: '4–5 page synthesis essay on themes and personal insights.' },
      { name: 'Participation & Attendance', points: '50 pts', description: 'Active engagement, consistent attendance, and preparation.' },
    ],
    grading: [
      { name: 'Listening Journals', points: 100, weight: '18%' },
      { name: 'Research Project', points: 150, weight: '27%' },
      { name: 'AI Group Project', points: 100, weight: '18%' },
      { name: 'Midterm Exam', points: 100, weight: '18%' },
      { name: 'Final Reflection Essay', points: 50, weight: '9%' },
      { name: 'Participation & Attendance', points: 50, weight: '9%' },
    ],
    gradingScale: [
      { grade: 'A', range: '95–100%' },
      { grade: 'A-', range: '90–94%' },
    ...
    schedule: [
      { week: 1, title: 'Introduction to African American Musical Traditions', date: 'August 25', description: 'Overview of themes: survival, innovation, community. Sound as resistance and identity.' },
      { week: 2, title: 'Spirituals and Vocal Traditions', date: 'September 1', description: 'The music of enslavement and early freedom. Call-and-response, coded messages, and the sacred-secular bridge.', assignments: 'Journal 1' },
      { week: 3, title: 'Blues: Foundation of American Popular Music', date: 'September 8', description: 'Origins in the rural South. The 12-bar form, field hollers, and emotional truth.', assignments: 'Journal 2' },
      { week: 4, title: 'Ragtime', date: 'September 15', description: 'Scott Joplin and syncopation as sophistication. Early Black composers and the evolution of notation.', assignments: 'Journal 3' },
      { week: 5, title: 'Jazz Origins and Early Development', date: 'September 22', description: 'From New Orleans to Harlem. The emergence of improvisation, swing, and ensemble conversation.', assignments: 'Journal 4' },
      { week: 6, title: 'Jubilee Quartets', date: 'September 29', description: 'From Fisk to the Golden Gate Quartet. Vocal harmony as community statement and spiritual expression.', assignments: 'Journal 5' },
      { week: 7, title: '1939–1969: From Spirituals to Swing to King', date: 'October 6', description: 'Carnegie Hall\'s "Spirituals to Swing," Civil Rights music, and the Harlem Cultural Festival (Summer of Soul).', assignments: 'Journal 6' },
      { week: 8, title: '1970s: James Brown, Funk, Disco, and Detroit Techno', date: 'October 13', description: 'Groove as power; rhythm as protest. Funk, Afrofuturism, and the rise of Black electronic sound.', assignments: 'Midterm Exam' },
      { week: 9, title: 'Hip-Hop Culture and Rap Music', date: 'October 20', description: 'From the Bronx to the world. The DJ, the MC, and the politics of the street.', assignments: 'Journal 7' },
      { week: 10, title: 'Contemporary R&B and Neo-Soul', date: 'October 27', description: 'The soul revival and the return of live musicianship. Lauryn Hill, D\'Angelo, Erykah Badu.', assignments: 'Journal 8' },
      { week: 11, title: 'Gospel\'s Modern Evolution', date: 'November 3', description: 'From traditional quartet to praise and worship. Kirk Franklin, Yolanda Adams, and sacred-pop fusion.', assignments: 'Journal 9' },
      { week: 12, title: 'Jazz Fusion and Modern Jazz', date: 'November 10', description: 'Miles Davis and Herbie Hancock\'s electric turn. Hip-hop jazz, Robert Glasper, Kamasi Washington.', assignments: 'Journal 10' },
      { week: 13, title: 'Hip-Hop II: Contemporary Directions', date: 'November 17', description: 'Trap, drill, and conscious rap. Kendrick Lamar, J. Cole, Megan Thee Stallion.', assignments: 'Research Project Due' },
      { week: 14, title: 'AI Workday', date: 'November 24', description: 'Workshop on AI-assisted music creation. Exploration of authorship, ethics, and innovation.' },
      { week: 15, title: 'Group AI Presentations', date: 'December 1', description: 'Final showcase of AI Group Projects.', assignments: 'AI Project Presentations' },
      { week: 16, title: 'Final Exam & Reflection', date: 'December 8', description: 'Comprehensive review. The enduring soul of African American music in a technological age.', assignments: 'Final Reflection Essay' },
    ],
  },
