    ...
    <div className="flex flex-col flex-1">
      ...
      <section className="mx-auto w-full max-w-3xl px-6 py-10">
        ...
        >
          ...
          <div className="flex-1">
            <div className="text-sm font-semibold text-foreground">Sight-Singing Lab <span className="ml-1 rounded bg-primary/10 px-1.5 py-0.5 text-xs font-semibold uppercase text-primary">Experimental</span></div>
                        ...
                        <li key={lesson.id} className="border-b border-border last:border-b-0">
                          ...
                          >
                            ...
                            {lesson.legacy_exercise_slug && (
                              <span className="text-xs font-medium uppercase tracking-wider text-[hsl(var(--brand-blue-dark))] whitespace-nowrap">Drill</span>
                            )}
                          </Link>
                        </li>
                      );
