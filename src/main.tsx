...
// Native-app crash telemetry: WKWebView/Android WebView users have no
// console, and store-review cycles are too slow to debug blind — every
// uncaught error in the APP is POSTed to the client-log edge function
// (read via `docker logs supabase-edge-functions | grep client-log`).
// No-op on the web. Solved the 2026-08-25 Android tablet post-auth crash.
