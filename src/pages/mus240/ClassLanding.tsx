          ...
          <section className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {cards.map((card) => {
              ...
              return (
                ...
                >
                  <div className="bg-white/95 backdrop-blur-sm rounded-2xl lg:rounded-3xl p-6 sm:p-4 lg:p-8 xl:p-10 shadow-xl border border-white/30 hover:bg-white hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 hover:scale-105">
