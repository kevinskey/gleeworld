            ...
            <CardContent className="p-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-card-foreground/70">AI tracks on Deezer daily</p>
                </div>
              </div>
            </CardContent>
          </Card>
          <Card className="border-primary/20 bg-card">
            <CardContent className="p-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-2xl font-bold text-card-foreground">75M</p>
                  <p className="text-sm text-card-foreground/70">Tracks removed by Spotify</p>
                </div>
              </div>
            </CardContent>
          </Card>
          <Card className="border-primary/20 bg-card">
            <CardContent className="p-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-2xl font-bold text-card-foreground">200+</p>
                  <p className="text-sm text-card-foreground/70">Artists signed open letter</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-card-foreground/70">Major lawsuits filed</p>
                </div>
              </div>
            </CardContent>
          </Card>
