...
import { ArrowLeft, CheckCircle, FileText, HelpCircle, X } from 'lucide-react';
      ...
      {showGuidelines && (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center">
          <Rnd
            ...
            className="bg-background rounded-lg shadow-2xl border"
          >
            <div className="flex flex-col h-full">
              <div className="drag-handle cursor-move border-b px-6 py-4 flex items-center justify-between">
                <div>
