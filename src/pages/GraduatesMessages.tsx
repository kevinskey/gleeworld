...
interface UserMessage extends GraduatesMessage {
  is_own_message: boolean;
}

export default function GraduatesMessages() {
  ...
  const checkAlumnaStatusAndFetchMessages = async () => {
    ...
    try {
      // Check if user is verified graduate
      ...
      const verified = profileData?.role === 'graduate' && profileData?.verified === true;
            ...
            <div className="space-y-2">
              ...
              <Select value={visibleTo} onValueChange={setVisibleTo}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="alumnae_only">Graduates Only</SelectItem>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                ...
                Recent Messages from Graduates
              </CardTitle>
            </CardHeader>
            <CardContent>
