...
export const GleeWorldLanding = () => {
  ...
  return (
    <div 
      className="min-h-screen bg-gradient-to-br from-spelman-blue-light/10 via-background to-spelman-blue-dark/10 relative overflow-hidden md:bg-center mobile-bg-cropped"
      style={{
    ...
    >
      {/* Overlay to blend historic image with gradients */}
      <div className="absolute inset-0 bg-gradient-to-br from-spelman-blue-light/20 via-background/80 to-spelman-blue-dark/20"></div>
