...
export const GleeWorldLanding = () => {
  ...
  return (
    <div 
      className="min-h-screen bg-gradient-to-br from-spelman-blue-light/10 via-background to-spelman-blue-dark/10 relative overflow-hidden bg-center md:bg-center"
      style={{
